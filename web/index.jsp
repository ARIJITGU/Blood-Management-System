...
<center><font color="red" size="5">Form Submitted Successfully. You will get notified within 24 hours.</font></center>
    ...
    %>
<center><font color="red" size="5"></font>Invalid Data! Try Again</center>
    <%
        }
    %>
<center>
    <h1> ENTER YOUR DETAILS TO REQUEST FOR BLOOD</h1></center>
<form action="indexFormAction.jsp" method="post">
    <center>
        ...
        <input type="mail" name="email" placeholder="Enter Your Email Address" required="">
